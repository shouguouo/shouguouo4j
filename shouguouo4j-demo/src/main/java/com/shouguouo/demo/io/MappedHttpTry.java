...
/**
 * 命令行参数传入文件名，文件内容作为OUTPUT_FILE的内容，通过收集多个ByteBuffer的内容写出
 * MappedByteBuffer与gather的结合
 *
 * @author shouguouo
 * @date 2022-03-27 20:41:10
 */
public class MappedHttpTry {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        try {
            // 将输入文件作为第三个ByteBuffer
            FileInputStream fis = new FileInputStream(file);
            FileChannel fc = fis.getChannel();
            // 内存映射文件，使用方式同普通ByteBuffer
